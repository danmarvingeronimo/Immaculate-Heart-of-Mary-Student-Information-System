<%@ Page Title="" Language="C#" MasterPageFile="~/Online Application/OnlineApplication.master" AutoEventWireup="true" CodeFile="Application.aspx.cs" Inherits="Online_Application_Application" %>
            ...
            <div class="form-group">
                <div class="col-lg-offset-4 col-lg-8">
                    <asp:Button ID="btnApply" runat="server"
                        CssClass="btn btn-success" Text="Next Page"
