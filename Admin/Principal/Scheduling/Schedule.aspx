                                    ...
                                    <asp:ListView ID="lvSched" runat="server"
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <asp:Literal ID="ltTimeslot_ID" runat="server"
                                                    Text='<%#Eval("ScheduleID") %>' Visible="false" />
                                        ...
                                        <i class="fa fa-exclamation"></i>
                                                    ...
                                                    <asp:LinkButton ID="btnEmptySched" runat="server"
                                                        class="btn btn-xs btn-warning" CommandName="deletesched">
    ...
    <div class="form-group">
        <div class="col-lg-offset-4 col-lg-4">
            <asp:Label ID="success" class="col-lg-4" ForeColor="Green" runat="server" Visible="false">
                <strong>Success!</strong> Subject & Schedule unassigned
            </asp:Label>
        </div>
    </div>
