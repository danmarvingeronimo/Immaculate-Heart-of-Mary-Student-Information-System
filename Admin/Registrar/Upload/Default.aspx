<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" MasterPageFile="~/Admin/Registrar/Registrar.master" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <form id="form1" runat="server">
        <asp:FileUpload style="float:left; margin-left:20px; " ID="Upload" runat="server" /> <br /><br />
        <asp:Button style="float:left; margin-left:20px; width:100px;" ID="Button1" runat="server" Text="Upload" OnClick="Button1_Click"  class="btn btn-block btn-primary" />
        <br /> <br />
