...
public partial class Admin_IT_Admin_Admin_Audit_Log_Audit : System.Web.UI.Page
{
    ...
    void GetAuditStudent()
    {
        ...
        {
            con.Open();
            string Audit = @"Select Audit_ID,Time_Stamp,Title,Description FROM AUDIT_LOG_TEACHER";
    ...
    protected void lvAudit_ItemDataBound1(object sender, ListViewItemEventArgs e)
    {
