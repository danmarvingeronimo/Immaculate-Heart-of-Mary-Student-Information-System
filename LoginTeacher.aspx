<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LoginTeacher.aspx.cs" Inherits="TeacherLogin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" Runat="Server">
     <div class="divider"></div>
            <h1 class="single">TEACHER PORTAL LOG IN</h1>
    <form runat="server" class="form-horizontal" align="middle">
            ...
            <div class="form-group">
                <div class="col-lg-offset-4 col-lg-8">
                    <br />
                    <asp:Button ID="btnLogin" runat="server" class="btn btn--right" Type="submit" Text="Login" OnClick="btnLogin_Click"/>
                         <br /><br />
                </div>
            </div>
        </div>
